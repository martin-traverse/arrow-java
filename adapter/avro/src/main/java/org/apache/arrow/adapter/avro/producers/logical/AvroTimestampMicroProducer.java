...
/**
 * Producer that produces timestamp (microseconds) values from a {@link TimeStampMicroVector},
 * writes data to an Avro encoder.
 */
public class AvroTimestampMicroProducer extends BaseAvroProducer<TimeStampMicroVector> {
